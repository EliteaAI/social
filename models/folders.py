...
class EntityFolder(db_tools.AbstractBaseMixin, db.Base):
    """Generic folder for organizing entities (applications, skills, toolkits, configurations)."""
    ...
    entity_type: Mapped[str] = mapped_column(String(32), nullable=False, index=True)  # 'application', 'skill', 'toolkit', 'configuration'
    sub_type: Mapped[str] = mapped_column(String(32), nullable=True)  # 'openai', 'pipeline' for apps; 'mcp' for toolkits
